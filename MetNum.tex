...
\begin{prop}
	Sea $f\in C^2[a,b]$. Se $p\in[a,b]$ tal que $f(p) = 0$ y $f'(p) \neq 0$. Entonces, existe $\delta$ tal que si $p_0\in[p-\delta,p+\delta]$, entonces el método de newton converge al cero de $f$. Formalmente, la sucesión $p_{n+1} = p_n - \dfrac{f(p_n)}{f'(p_n)}$ converge a $p$.
\end{prop}
